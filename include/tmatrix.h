...
public:
  ...
  TDynamicVector& operator=(TDynamicVector&& v) noexcept // гарантируем, что исключений не будет
  {
      sz = 0;
      delete[] pMem;
      pMem = nullptr;
...
{
  using TDynamicVector<TDynamicVector<T>>::pMem; // рмем вектор типа TDynamicVector из векторов типа TDynamicVector
